...
BEGIN
    ...
    main_block: BEGIN
        ...
        IF v_login_id IS NULL OR v_new_password IS NULL OR v_reset_token IS NULL THEN
            ...
            SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.responseCode', 1);
            SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.message', 'Login ID, New Password and Reset Token are required.');
        ...
        IF v_reset_token <>  v_db_reset_token THEN
            ...
            SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.responseCode', 1);
            SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.message', 'The reset token is invalid.');
        ...
        IF NOW() > v_token_expiry THEN
            ...
            SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.responseCode', 1);
            SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.message', 'The reset token has expired.');
        ...
        SET pjRespObj = buildJSONSmart(pjRespObj, 'jHeader.message', 'Your password has been successfully reset.');
