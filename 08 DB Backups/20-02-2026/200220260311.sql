...
LOCK TABLES `external_interfaces` WRITE;
...
LOCK TABLES `gft_ui_metadata` WRITE;
...
CREATE TABLE `orders` (
  ...
  `order_type` enum('DO','IOC','GTC') DEFAULT NULL,
...
LOCK TABLES `outbound_msgs` WRITE;
...
CREATE TABLE `reverse_lookup` (
  `marketing_rec_id` int NOT NULL AUTO_INCREMENT,
  `phone` varchar(20) DEFAULT NULL,
  `first_name` varchar(100) DEFAULT NULL,
  `last_name` varchar(100) DEFAULT NULL,
...
LOCK TABLES `reverse_lookup` WRITE;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `generateOtp` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `generateOtp`(
    IN  p_contact_type   ENUM('email','phone','loginid'),
...
BEGIN
    ...
    VALUES (
        ...
        v_expiry,
        5,        -- default retries
        0         -- next OTP available immediately
    );

    -- OUT param (ignored by caller)
    SET p_ignore = 1;

    /*
      Optional: trigger SMS/Email sending asynchronously here
    */
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `queueOutboundMessage` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `queueOutboundMessage`(
										IN  pReqObj JSON,
										OUT pResObj JSON
									)
BEGIN
...
-- Dump completed on 2026-02-20 15:11:44
